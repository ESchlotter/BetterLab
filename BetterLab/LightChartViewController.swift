//
//  LightChartViewController.swift
//  BetterLab
//
...
class LightChartViewController: UIViewController, NSURLConnectionDelegate, NSURLConnectionDataDelegate, ChartViewDelegate {
